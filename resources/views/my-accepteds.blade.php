            ...
            <div id="panel1" class="tab_panel">
                ...
                <div class="grid grid-cols-1 gap-4">
                    ...
                    <div class="bg-white shadow p-6 rounded-lg">
                        ...
                        <div class="mt-4 flex">
                            <a href="{{ route('post.ongoing2', ['id' => $acceptedOngoing->post->id]) }}" class="btn btn-primary mr-2"
                                role="button">
                                {{ __('詳細') }}
                            </a>
                        </div>
            ...
            <div id="panel2" class="tab_panel">
                ...
                <div class="grid grid-cols-1 gap-4">
                    ...
                    <div class="bg-white shadow p-6 rounded-lg">
                        ...
                        <div class="mt-4 flex">
                            <a href="{{ route('post.ongoing2', ['id' => $acceptedCompleted->post->id]) }}" class="btn btn-primary mr-2"
                                role="button">
                                {{ __('詳細') }}
                            </a>
                        </div>
